...
import { Task } from '../../main/model/task';
import * as moment from 'moment';
import { UserProperties } from '../../main/model/user-properties';
import { TokenService } from './token.service';
import { TaskOptions } from '../../main/model/task-options';
import { UserLoginData } from '../../main/model/user';
...
export class MainTasklyService {
  ...
  // Account activities
  signInUser(user: UserLoginData): Observable<string> {
    return this.httpClient.post(`${this.signInURL}`, user, {
      responseType: 'text'
    });
  }

  signUpUser(user: UserLoginData) {
